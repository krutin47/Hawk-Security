                                ...
                                <div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            ...
                                            <input type="text" name="monday" id="monday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="monday" id="monday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            <label for="tuesday">Tuesday</label>
                                            <input type="text" name="tuesday" id="tuesday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="tuesday" id="tuesday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            <label for="wednesday">Wednesday</label>
                                            <input type="text" name="wednesday" id="wednesday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="wednesday" id="wednesday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            <label for="thursday">Thursday</label>
                                            <input type="text" name="thursday" id="thursday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="thursday" id="thursday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            <label for="friday">Friday</label>
                                            <input type="text" name="friday" id="friday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="friday" id="friday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            <label for="saturday">Saturday</label>
                                            <input type="text" name="saturday" id="saturday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="saturday" id="saturday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
                                    <div class="ib vt w14 tabw25 mw100">
                                        <div class="field">
                                            <label for="sunday">Sunday</label>
                                            <input type="text" name="sunday" id="sunday" onChange={this.onChangeStartTime}></input>
                                            <input type="text" name="sunday" id="sunday" onChange={this.onChangeEndTime}></input>
                                        </div>
                                    </div>
