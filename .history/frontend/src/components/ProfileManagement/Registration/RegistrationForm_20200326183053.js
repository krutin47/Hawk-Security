...
class RegistrationForm extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        console.log("nextProps.success ------> ", this.nextProps.success);
        console.log("nextProps.errors ------> ", this.nextProps.errors);

        if(nextProps.success !== null && nextProps.success.size > 0) {
            this.setState({
                success: nextProps.success,
                success_msg: <Alert key='success' variant='success'>Yey! You successfully Registered</Alert>
            });
            toast("you are Register.");
            //this.props.history.push("/login");
        }
        if (nextProps.errors !== null && nextProps.errors.size > 0) {
    ...
    render(){
        return(
            <form>  
                ...
                { console.log("i will alert the user....", this.state.success_msg) }
                <ToastContainer />
                { console.log("i will alert the user....", this.state.success_msg) }
            </form>
        );
