    ...
    render(){
        ...
        errorMessage_Email = () => {
            if(this.state.emailTouch) {   
                ...
                //          return <p className="has-error">Email Id is already taken</p>;
                //     } else {
                        console.log("i am in else........");
                        if(this.state.emailValid){
                            return <p className="isValid">Sweet! Email Id is valid</p>
                        } else {
                            return <p className="has-error">Please Enter a valid Email Id</p>
                        }
                    }
                    console.log(errorMessage_Email);
                // })
