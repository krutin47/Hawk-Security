...
class LoginForm extends React.Component {
    ...
    render(){
        ...
        if(this.state.emailTouch) {
            ...
            ? errorMessage = <p className="isValid">Sweet! Email Id is valid</p>
            : errorMessage = <p className="has-error">Please Enter a valid Email Id</p>
        }
                        ...
                        <div className="form-label-group">
                            <div className={`form-group ${this.errorClass(this.state.formErrors.password)}`}>
                                ...
                                <input type="password" className="form-control" name="password"
                                    ...
                                    onChange={this.handleUserInput}  />
                                {console.log("password is dirty?", this.state.passwordTouch)}
