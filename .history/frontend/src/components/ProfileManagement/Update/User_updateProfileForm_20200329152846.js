                    ...
                    <div className="col-md-12">
                        <div className="form-label-group">
                            <div>
                                ...
                                {/* // TODO: change class dynamically to manipulate the border of the input */}
                                <input className={'form-group ' + (this.errorClass(this.state.formErrors.address))} 
                                    type="text" 
                                    name="address"
                    ...
                    <div className="col-md-12">
                        <div className="form-label-group">
                            <div>
                                ...
                                {/* // TODO: change class dynamically to manipulate the border of the input */}
                                <input className={`form-group ${this.errorClass(this.state.formErrors.phone)}`} 
                                    type="tel" 
                                    name="phone"
                    ...
                    <div className="col-md-12">
                        <div className="form-label-group">
                            <div>
                                ...
                                {/* // TODO: change class dynamically to manipulate the border of the input */}
                                <input className={`form-group ${this.errorClass(this.state.formErrors.gender)}`} 
                                    type="text" 
...
UserUpdateProfileForm.propTypes = {
...
export default connect(mapStateToProps, { updateUser })(withRouter(UserUpdateProfileForm));