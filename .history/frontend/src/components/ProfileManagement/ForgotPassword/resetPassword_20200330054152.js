...
class ResetPassword extends Component {
    ...
    componentDidMount() {
        ...
        var _reset = url.searchParams.get("reset");
        console.log("ResetPassword -> componentDidMount -> reset", _reset)
        console.log("ResetPassword -> componentDidMount -> reset", typeof _reset)

        this.setState({
            reset_: String(_reset)
        });
        console.log("ResetPassword -> componentDidMount -> reset", this.state.reset_)
    }
