...
class ResetPassword extends Component {
    ...
    componentDidMount() {
        ...
        console.log("ResetPassword -> componentDidMount -> window.location.href", window.location.href);
        console.log("ResetPassword -> render -> url_string", this.state.url_string);
    }
    ...
    onSubmitForm(e){
        ...
        if(this.state.formValid) {
            ...
            var url = new URL(this.state.url_string);
            console.log("ResetPassword -> onSubmitForm -> url", url)
            var reset = url.searchParams.get("reset");
            console.log("ResetPassword -> onSubmitForm -> reset", reset)
