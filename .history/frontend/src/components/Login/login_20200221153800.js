        ...
        <form>
          <div class="login-container jumbotron">
            <div class="row">
              ...
              <div class="col-md-12">
                <br/>
                <Button class="btn btn-success pull-right" block bsSize="large" type="submit" onClick={() => setShow(false)}>Login </Button>
            ...
            <div class="row">
              <div class="col-md-12">
                <div>
                  <br/>
                  <Alert show  class="alert alert-success">Login Successful!</div>
                </div>
                <div>
                  <br/>
