                ...
                <div className="container text-center text-md-left mt-5">
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto"></hr>
                            <p><i className="fab fa-home mr-3"></i> New York, NY 10012, US</p>
                            <p><i className="fab fa-envelope mr-3"></i> info@example.com</p>
                            <p><i className="fab fa-phone mr-3"></i> + 01 234 567 88</p>
                            <p><i className="fab fa-print mr-3"></i> + 01 234 567 89</p>
                        </div>
                        {/* <!-- Grid column --> */}
